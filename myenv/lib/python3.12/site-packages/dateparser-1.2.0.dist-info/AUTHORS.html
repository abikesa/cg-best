...
<link rel="preload" as="script" href="../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/lib/python3.12/site-packages/dateparser-1.2.0.dist-info/AUTHORS';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../_sources/myenv/lib/python3.12/site-packages/dateparser-1.2.0.dist-info/AUTHORS.rst" target="_blank"
...
<p>Currently, more than 100 committers have contributed to this project, making this
contributors list really hard to maintain, so we have decided to stop updating
this list.</p>
<p>To see the people behind this code, you can run <code class="docutils literal notranslate"><span class="pre">git</span> <span class="pre">shortlog</span> <span class="pre">-s</span> <span class="pre">-n</span></code> or visit the
contributions section in Github: <a class="github reference external" href="https://github.com/scrapinghub/dateparser/graphs/contributors">scrapinghub/dateparser</a></p>
<p>We really appreciate <strong>all the people that has contributed to this project with their
time and ideas</strong>. Special mention to <strong>Waqas Shabir</strong> (waqasshabbir), <strong>Eugene Amirov</strong>
(Allactaga) and <strong>Artur Sadurski</strong> (asadurski) for creating and maintaining this awesome
project.</p>
<p>To all of you… thank you for building and improving this!</p>
</section>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv/lib/python3.12/site-packages/dateparser-1.2.0.dist-info"
        },
